...
(function(b) {
	...
	b.extend(!0, f.defaults, {
		dom : "<'row'<'col-xs-6'l><'col-xs-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-6'i><'col-sm-6'p>>",
		renderer : "bootstrap"
	...
	f.ext.renderer.pageButton.bootstrap = function(a, h, r, m, j, n) {
		...
		} catch (u) {} q(b(h).empty().html('<ul class="pagination pagination-sm"/>').children("ul"), m);i && b(h).find("[data-dt-idx=" + i + "]").focus()
	};return f
});