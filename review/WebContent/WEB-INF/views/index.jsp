			...
			<div class="jumbotron">
				<p >
				  ...
				  <br />
				   ...
				   <font size="8" color="#FF8000">Share </font>
				   </div>
				   <div class="hidden-lg hidden-md hidden-sm main-texts-mobile">
				   <font size="5" color="#FF8000"> your Experience</font>
				    </div>							   
				   ...
				   <div class="hidden-lg hidden-md hidden-sm main-texts-mobile">
				    <font size="4" color="#A4A4A4">that you’ve used</font>
				    </div>	
				  ...
				  <div class="hidden-xs main-text-bottom-web">	   
				   ...
				   <div class="hidden-lg hidden-md hidden-sm main-texts-mobile">
				    <font size="4" color="#A4A4A4">that you’ve watched</font>
				    </div>	
				  ...
				  <div class="hidden-xs main-text-bottom-web main-bottom-web">	   
				   ...
				   <div class="hidden-lg hidden-md hidden-sm main-texts-mobile main-bottom-mobile">
				    <font size="4" color="#A4A4A4">that you’ve been</font>
				    </div>								 
				</p>
