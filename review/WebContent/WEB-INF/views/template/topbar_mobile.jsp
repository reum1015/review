 ...
 <div class="topmenu-main col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<img alt="main" src="${pageContext.request.contextPath}/assets/imgs/img/title.jpg"
	 height="50px" width="140px"  />
       ...
       <!--// top_main big -->
         <!-- top_main small -->             
       <div class="topmenu-icon hidden-lg hidden-md hidden-md  col-xs-1" >       
	...
	<img alt="main" src="${pageContext.request.contextPath}/assets/icon/reviewicon.png"
	 height="50px" width="50px"  />
             ...
             <div class="topmenu-brands hidden-lg hidden-md col-sm-offset-4 col-sm-4 col-xs-offset-2 col-xs-5" >       
       <a class="topmenu-brands" href="${pageContext.request.contextPath}/index" >
	<img alt="main" src="${pageContext.request.contextPath}/assets/imgs/img/title.jpg"
	 height="50px" width="140px"  />
	</a>	
