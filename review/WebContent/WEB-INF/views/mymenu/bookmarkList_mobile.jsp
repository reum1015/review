...
<c:url var="prevUrl" value="/mymenu/bookmarkList_mobile?member_id=${loginInfo.id}">
...
<c:url var="pageUrl" value="/mymenu/bookmarkList_mobile?member_id=${loginInfo.id}">
	<c:param name="keyword" value="${keyword}"></c:param>
...
<c:url var="nextUrl" value="/mymenu/bookmarkList_mobile?member_id=${loginInfo.id}">
	<c:param name="keyword" value="${keyword}"></c:param>
