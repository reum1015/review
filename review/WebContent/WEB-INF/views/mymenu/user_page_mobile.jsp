...
${readMember.introduce} 
					...
					<a href="#" class=" col-lg-4  col-md-4  col-sm-4 col-xs-6 btn btn-white btn-large "><span class="user-menu-bar btn btn-large"><font size="5" color="#FF8000" >Boards</font></span></a>
				<a href="${pageContext.request.contextPath}/mymenu/user_page2_mobile?member_id=${readMember.id}" class="col-lg-4 col-md-4 col-sm-4 col-xs-4 btn btn-white btn-large "><span class="user-menu-bar btn btn-large"><font class="user-menu-bar" size="5" color="#FF8000">List</font></span></a>
	         <c:if test="${readMember.id==loginInfo.id}">
					            	...
					            	<!-- 제목 + 작성자 + 조회수 -->
					            		<div class="item col-lg-9 col-md-9 col-sm-9 col-xs-6">
											...
											<small>
												...
												<br /> 
												<small><font size="2" color=#000>${article.reg_date}</font></small>
											<small class="pull-right"><font size="2" color=#000> Hit: ${article.hit}</font></small> 
							<div class="hidden-xs">	
...
<c:url var="prevUrl" value="/mymenu/user_page_mobile?member_id=${readMember.id}">
...
<c:url var="pageUrl" value="/mymenu/user_page_mobile?member_id=${readMember.id}">
...
<c:url var="nextUrl" value="/mymenu/user_page_mobile?member_id=${readMember.id}">
