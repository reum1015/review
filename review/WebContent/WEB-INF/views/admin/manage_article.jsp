...
<body>
	...
	<div class="containers" >
      ...
      action="${pageContext.request.contextPath}/admin/manage_article_ok">
			<div class="form-groups">
			<h2>total article</h2>
			<h4>total article count <font size="15" color="#484848">${total_count}</font></h4>			
			</div>	
			
			<hr/>
				<div class="form-groups">
				<h2>article count by date</h2>
			<h4>total article count <font size="15" color="#484848">${total_article_date}</font></h4>
			<div>
