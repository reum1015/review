...
@WebServlet("/article/article_edit_mobile")
public class ArticleEditMobile extends BaseController {
   private static final long serialVersionUID = -1391748040235555563L;
      ...
      public String doRun(HttpServletRequest request, HttpServletResponse response) 
         ...
         if (article_id == 0) {
            web.redirect(null, "do not get aritlce_id number.");
            sqlSession.close();
            return null;
         }
      ...
      String view = "article/article_edit_mobile";
      return view;
   }
