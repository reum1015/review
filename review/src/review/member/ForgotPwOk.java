...
@WebServlet("/member/forgot_pw_ok")
public class ForgotPwOk extends BaseController {
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) 
		...
		web.redirect(web.getRootPath() + "/member/login", "We've sent an email. Click the link in the email to reset your password.");
